//!
//! This is NOT an example how to normally use the renderer.
//! This is meant as a playground to testing the world encoding
//! in isolation from the rest of the engine, using rendy directly
//! as much as possible. To be removed once proper rendy support lands.
//!
...
lazy_static::lazy_static! {
    static ref VERTEX: StaticShaderInfo = StaticShaderInfo::new(
        concat!(env!("CARGO_MANIFEST_DIR"), "/examples/rendy_encoding/shader.vert"),
        ShaderKind::Vertex,
        SourceLanguage::GLSL,
        "main",
    );
    ...
    static ref FRAGMENT: StaticShaderInfo = StaticShaderInfo::new(
        concat!(env!("CARGO_MANIFEST_DIR"), "/examples/rendy_encoding/shader.frag"),
        ShaderKind::Fragment,
        SourceLanguage::GLSL,
        "main",
    );
